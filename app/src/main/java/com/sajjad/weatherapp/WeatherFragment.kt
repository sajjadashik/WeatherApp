...
import com.sajjad.weatherapp.adapters.ForecastAdapter
import com.sajjad.weatherapp.databinding.FragmentWeatherBinding
import com.sajjad.weatherapp.prefs.WeatherPreference
...
class WeatherFragment : Fragment() {
    ...
    private fun convertQueryToLatLng(query: String?) {
        ...
        if (addressList.isNotEmpty()){
            ...
            Toast.makeText(requireActivity(),"Invalid City", Toast.LENGTH_SHORT).show()
        }
    }
